...
# **getOrderMetrics**
> \SellingPartnerApi\Model\GetOrderMetricsResponse getOrderMetrics($marketplace_ids, $interval, $granularity, $granularity_time_zone, $buyer_type, $fulfillment_network, $first_day_of_week, $asin, $sku)
...
[**\SellingPartnerApi\Model\GetOrderMetricsResponse**](../Model/GetOrderMetricsResponse.md)
