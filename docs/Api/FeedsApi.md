...
# **createFeed**
> \SellingPartnerApi\Model\CreateFeedResponse createFeed($body)
...
$body = new \SellingPartnerApi\Model\CreateFeedSpecification(); // \SellingPartnerApi\Model\CreateFeedSpecification | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\SellingPartnerApi\Model\CreateFeedSpecification**](../Model/CreateFeedSpecification.md)|  |

### Return type

[**\SellingPartnerApi\Model\CreateFeedResponse**](../Model/CreateFeedResponse.md)
...
# **createFeedDocument**
> \SellingPartnerApi\Model\CreateFeedDocumentResponse createFeedDocument($body)
...
$body = new \SellingPartnerApi\Model\CreateFeedDocumentSpecification(); // \SellingPartnerApi\Model\CreateFeedDocumentSpecification | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\SellingPartnerApi\Model\CreateFeedDocumentSpecification**](../Model/CreateFeedDocumentSpecification.md)|  |

### Return type

[**\SellingPartnerApi\Model\CreateFeedDocumentResponse**](../Model/CreateFeedDocumentResponse.md)
...
# **getFeed**
> \SellingPartnerApi\Model\Feed getFeed($feed_id)
...
[**\SellingPartnerApi\Model\Feed**](../Model/Feed.md)
...
# **getFeedDocument**
> \SellingPartnerApi\Model\FeedDocument getFeedDocument($feed_document_id)
...
[**\SellingPartnerApi\Model\FeedDocument**](../Model/FeedDocument.md)
...
# **getFeeds**
> \SellingPartnerApi\Model\GetFeedsResponse getFeeds($feed_types, $marketplace_ids, $page_size, $processing_statuses, $created_since, $created_until, $next_token)
...
[**\SellingPartnerApi\Model\GetFeedsResponse**](../Model/GetFeedsResponse.md)
