...
$apiInstance = new SellingPartnerApi\Api\OrdersV0Api(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client()
);
$order_id = "order_id_example"; // string | An Amazon-defined order identifier, in 3-7-7 format.
$payload = new \SellingPartnerApi\Model\ConfirmShipmentRequest(); // \SellingPartnerApi\Model\ConfirmShipmentRequest | Request body of confirmShipment.
 ...
 **payload** | [**\SellingPartnerApi\Model\ConfirmShipmentRequest**](../Model/ConfirmShipmentRequest.md)| Request body of confirmShipment. |
...
# **getOrder**
> \SellingPartnerApi\Model\GetOrderResponse getOrder($order_id)
...
[**\SellingPartnerApi\Model\GetOrderResponse**](../Model/GetOrderResponse.md)
...
# **getOrderAddress**
> \SellingPartnerApi\Model\GetOrderAddressResponse getOrderAddress($order_id)
...
[**\SellingPartnerApi\Model\GetOrderAddressResponse**](../Model/GetOrderAddressResponse.md)
...
# **getOrderBuyerInfo**
> \SellingPartnerApi\Model\GetOrderBuyerInfoResponse getOrderBuyerInfo($order_id)
...
[**\SellingPartnerApi\Model\GetOrderBuyerInfoResponse**](../Model/GetOrderBuyerInfoResponse.md)
...
# **getOrderItems**
> \SellingPartnerApi\Model\GetOrderItemsResponse getOrderItems($order_id, $next_token)
...
[**\SellingPartnerApi\Model\GetOrderItemsResponse**](../Model/GetOrderItemsResponse.md)
...
> \SellingPartnerApi\Model\GetOrderItemsBuyerInfoResponse getOrderItemsBuyerInfo($order_id, $next_token)
...
[**\SellingPartnerApi\Model\GetOrderItemsBuyerInfoResponse**](../Model/GetOrderItemsBuyerInfoResponse.md)
...
> \SellingPartnerApi\Model\GetOrderRegulatedInfoResponse getOrderRegulatedInfo($order_id)
...
[**\SellingPartnerApi\Model\GetOrderRegulatedInfoResponse**](../Model/GetOrderRegulatedInfoResponse.md)
...
[**\SellingPartnerApi\Model\GetOrdersResponse**](../Model/GetOrdersResponse.md)
...
$order_id = "order_id_example"; // string | An orderId is an Amazon-defined order identifier, in 3-7-7 format.
$payload = new \SellingPartnerApi\Model\UpdateVerificationStatusRequest(); // \SellingPartnerApi\Model\UpdateVerificationStatusRequest | The request body for the updateVerificationStatus operation.
...
------------- | ------------- | ------------- | -------------
 **order_id** | **string**| An orderId is an Amazon-defined order identifier, in 3-7-7 format. |
 **payload** | [**\SellingPartnerApi\Model\UpdateVerificationStatusRequest**](../Model/UpdateVerificationStatusRequest.md)| The request body for the updateVerificationStatus operation. |
