...
# **createReport**
> \SellingPartnerApi\Model\CreateReportResponse createReport($body)
...
$body = new \SellingPartnerApi\Model\CreateReportSpecification(); // \SellingPartnerApi\Model\CreateReportSpecification | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\SellingPartnerApi\Model\CreateReportSpecification**](../Model/CreateReportSpecification.md)|  |

### Return type

[**\SellingPartnerApi\Model\CreateReportResponse**](../Model/CreateReportResponse.md)
...
> \SellingPartnerApi\Model\CreateReportScheduleResponse createReportSchedule($body)
...
$body = new \SellingPartnerApi\Model\CreateReportScheduleSpecification(); // \SellingPartnerApi\Model\CreateReportScheduleSpecification | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\SellingPartnerApi\Model\CreateReportScheduleSpecification**](../Model/CreateReportScheduleSpecification.md)|  |

### Return type

[**\SellingPartnerApi\Model\CreateReportScheduleResponse**](../Model/CreateReportScheduleResponse.md)
...
# **getReport**
> \SellingPartnerApi\Model\Report getReport($report_id)
...
[**\SellingPartnerApi\Model\Report**](../Model/Report.md)
...
# **getReportDocument**
> \SellingPartnerApi\Model\ReportDocument getReportDocument($report_document_id)
...
[**\SellingPartnerApi\Model\ReportDocument**](../Model/ReportDocument.md)
...
# **getReportSchedule**
> \SellingPartnerApi\Model\ReportSchedule getReportSchedule($report_schedule_id)
...
[**\SellingPartnerApi\Model\ReportSchedule**](../Model/ReportSchedule.md)
...
# **getReportSchedules**
> \SellingPartnerApi\Model\ReportScheduleList getReportSchedules($report_types)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **report_types** | [**string[]**](../Model/string.md)| A list of report types used to filter report schedules. Refer to [Report Type Values](https://developer-docs.amazon.com/sp-api/docs/report-type-values) for more information. |

### Return type

[**\SellingPartnerApi\Model\ReportScheduleList**](../Model/ReportScheduleList.md)
...
# **getReports**
> \SellingPartnerApi\Model\GetReportsResponse getReports($report_types, $processing_statuses, $marketplace_ids, $page_size, $created_since, $created_until, $next_token)
...
[**\SellingPartnerApi\Model\GetReportsResponse**](../Model/GetReportsResponse.md)
