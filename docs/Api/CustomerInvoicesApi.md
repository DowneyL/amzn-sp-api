# SellingPartnerApi\CustomerInvoicesApi
...
# **getCustomerInvoice**
> \SellingPartnerApi\Model\CustomerInvoice getCustomerInvoice($purchase_order_number)
...
$apiInstance = new SellingPartnerApi\Api\CustomerInvoicesApi(
...
[**\SellingPartnerApi\Model\CustomerInvoice**](../Model/CustomerInvoice.md)
...
# **getCustomerInvoices**
> \SellingPartnerApi\Model\CustomerInvoiceList getCustomerInvoices($created_after, $created_before, $ship_from_party_id, $limit, $sort_order, $next_token)
...
[**\SellingPartnerApi\Model\CustomerInvoiceList**](../Model/CustomerInvoiceList.md)
