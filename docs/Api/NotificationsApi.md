...
# **createDestination**
> \SellingPartnerApi\Model\CreateDestinationResponse createDestination($body)
...
$body = new \SellingPartnerApi\Model\CreateDestinationRequest(); // \SellingPartnerApi\Model\CreateDestinationRequest | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\SellingPartnerApi\Model\CreateDestinationRequest**](../Model/CreateDestinationRequest.md)|  |

### Return type

[**\SellingPartnerApi\Model\CreateDestinationResponse**](../Model/CreateDestinationResponse.md)
...
# **createSubscription**
> \SellingPartnerApi\Model\CreateSubscriptionResponse createSubscription($body, $notification_type)
...
$body = new \SellingPartnerApi\Model\CreateSubscriptionRequest(); // \SellingPartnerApi\Model\CreateSubscriptionRequest | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\SellingPartnerApi\Model\CreateSubscriptionRequest**](../Model/CreateSubscriptionRequest.md)|  |
...
[**\SellingPartnerApi\Model\CreateSubscriptionResponse**](../Model/CreateSubscriptionResponse.md)
...
# **deleteDestination**
> \SellingPartnerApi\Model\DeleteDestinationResponse deleteDestination($destination_id)
...
[**\SellingPartnerApi\Model\DeleteDestinationResponse**](../Model/DeleteDestinationResponse.md)
...
> \SellingPartnerApi\Model\DeleteSubscriptionByIdResponse deleteSubscriptionById($subscription_id, $notification_type)
...
[**\SellingPartnerApi\Model\DeleteSubscriptionByIdResponse**](../Model/DeleteSubscriptionByIdResponse.md)
...
# **getDestination**
> \SellingPartnerApi\Model\GetDestinationResponse getDestination($destination_id)
...
[**\SellingPartnerApi\Model\GetDestinationResponse**](../Model/GetDestinationResponse.md)
...
# **getDestinations**
> \SellingPartnerApi\Model\GetDestinationsResponse getDestinations()
...
[**\SellingPartnerApi\Model\GetDestinationsResponse**](../Model/GetDestinationsResponse.md)
...
# **getSubscription**
> \SellingPartnerApi\Model\GetSubscriptionResponse getSubscription($notification_type)
...
[**\SellingPartnerApi\Model\GetSubscriptionResponse**](../Model/GetSubscriptionResponse.md)
...
# **getSubscriptionById**
> \SellingPartnerApi\Model\GetSubscriptionByIdResponse getSubscriptionById($subscription_id, $notification_type)
...
[**\SellingPartnerApi\Model\GetSubscriptionByIdResponse**](../Model/GetSubscriptionByIdResponse.md)
