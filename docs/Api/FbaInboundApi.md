...
# **confirmPreorder**
> \SellingPartnerApi\Model\ConfirmPreorderResponse confirmPreorder($shipment_id, $need_by_date, $marketplace_id)
...
[**\SellingPartnerApi\Model\ConfirmPreorderResponse**](../Model/ConfirmPreorderResponse.md)
...
# **confirmTransport**
> \SellingPartnerApi\Model\ConfirmTransportResponse confirmTransport($shipment_id)
...
[**\SellingPartnerApi\Model\ConfirmTransportResponse**](../Model/ConfirmTransportResponse.md)
...
> \SellingPartnerApi\Model\InboundShipmentResponse createInboundShipment($body, $shipment_id)
...
$body = new \SellingPartnerApi\Model\InboundShipmentRequest(); // \SellingPartnerApi\Model\InboundShipmentRequest | 
$shipment_id = "shipment_id_example"; // string | A shipment identifier originally returned by the createInboundShipmentPlan operation.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\SellingPartnerApi\Model\InboundShipmentRequest**](../Model/InboundShipmentRequest.md)|  |
 **shipment_id** | **string**| A shipment identifier originally returned by the createInboundShipmentPlan operation. |

### Return type

[**\SellingPartnerApi\Model\InboundShipmentResponse**](../Model/InboundShipmentResponse.md)
...
> \SellingPartnerApi\Model\CreateInboundShipmentPlanResponse createInboundShipmentPlan($body)
...
$body = new \SellingPartnerApi\Model\CreateInboundShipmentPlanRequest(); // \SellingPartnerApi\Model\CreateInboundShipmentPlanRequest | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\SellingPartnerApi\Model\CreateInboundShipmentPlanRequest**](../Model/CreateInboundShipmentPlanRequest.md)|  |

### Return type

[**\SellingPartnerApi\Model\CreateInboundShipmentPlanResponse**](../Model/CreateInboundShipmentPlanResponse.md)
...
# **estimateTransport**
> \SellingPartnerApi\Model\EstimateTransportResponse estimateTransport($shipment_id)
...
[**\SellingPartnerApi\Model\EstimateTransportResponse**](../Model/EstimateTransportResponse.md)
...
# **getBillOfLading**
> \SellingPartnerApi\Model\GetBillOfLadingResponse getBillOfLading($shipment_id)
...
[**\SellingPartnerApi\Model\GetBillOfLadingResponse**](../Model/GetBillOfLadingResponse.md)
...
# **getInboundGuidance**
> \SellingPartnerApi\Model\GetInboundGuidanceResponse getInboundGuidance($marketplace_id, $seller_sku_list, $asin_list)
...
[**\SellingPartnerApi\Model\GetInboundGuidanceResponse**](../Model/GetInboundGuidanceResponse.md)
...
# **getLabels**
> \SellingPartnerApi\Model\GetLabelsResponse getLabels($shipment_id, $page_type, $label_type, $number_of_packages, $package_labels_to_print, $number_of_pallets, $page_size, $page_start_index)
...
[**\SellingPartnerApi\Model\GetLabelsResponse**](../Model/GetLabelsResponse.md)
...
# **getPreorderInfo**
> \SellingPartnerApi\Model\GetPreorderInfoResponse getPreorderInfo($shipment_id, $marketplace_id)
...
[**\SellingPartnerApi\Model\GetPreorderInfoResponse**](../Model/GetPreorderInfoResponse.md)
...
# **getPrepInstructions**
> \SellingPartnerApi\Model\GetPrepInstructionsResponse getPrepInstructions($ship_to_country_code, $seller_sku_list, $asin_list)
...
[**\SellingPartnerApi\Model\GetPrepInstructionsResponse**](../Model/GetPrepInstructionsResponse.md)
...
# **getShipmentItems**
> \SellingPartnerApi\Model\GetShipmentItemsResponse getShipmentItems($query_type, $marketplace_id, $last_updated_after, $last_updated_before, $next_token)
...
[**\SellingPartnerApi\Model\GetShipmentItemsResponse**](../Model/GetShipmentItemsResponse.md)
...
> \SellingPartnerApi\Model\GetShipmentItemsResponse getShipmentItemsByShipmentId($shipment_id, $marketplace_id)
...
# **getShipments**
> \SellingPartnerApi\Model\GetShipmentsResponse getShipments($query_type, $marketplace_id, $shipment_status_list, $shipment_id_list, $last_updated_after, $last_updated_before, $next_token)
...
[**\SellingPartnerApi\Model\GetShipmentsResponse**](../Model/GetShipmentsResponse.md)
...
# **getTransportDetails**
> \SellingPartnerApi\Model\GetTransportDetailsResponse getTransportDetails($shipment_id)
...
[**\SellingPartnerApi\Model\GetTransportDetailsResponse**](../Model/GetTransportDetailsResponse.md)
...
# **putTransportDetails**
> \SellingPartnerApi\Model\PutTransportDetailsResponse putTransportDetails($shipment_id, $body)
...
$shipment_id = "shipment_id_example"; // string | A shipment identifier originally returned by the createInboundShipmentPlan operation.
$body = new \SellingPartnerApi\Model\PutTransportDetailsRequest(); // \SellingPartnerApi\Model\PutTransportDetailsRequest | 
...
------------- | ------------- | ------------- | -------------
 **shipment_id** | **string**| A shipment identifier originally returned by the createInboundShipmentPlan operation. |
 **body** | [**\SellingPartnerApi\Model\PutTransportDetailsRequest**](../Model/PutTransportDetailsRequest.md)|  |

### Return type

[**\SellingPartnerApi\Model\PutTransportDetailsResponse**](../Model/PutTransportDetailsResponse.md)
...
> \SellingPartnerApi\Model\InboundShipmentResponse updateInboundShipment($body, $shipment_id)
...
# **voidTransport**
> \SellingPartnerApi\Model\VoidTransportResponse voidTransport($shipment_id)
...
[**\SellingPartnerApi\Model\VoidTransportResponse**](../Model/VoidTransportResponse.md)
