...
> \SellingPartnerApi\Model\SmallAndLightEligibility getSmallAndLightEligibilityBySellerSKU($seller_sku, $marketplace_ids)
...
[**\SellingPartnerApi\Model\SmallAndLightEligibility**](../Model/SmallAndLightEligibility.md)
...
> \SellingPartnerApi\Model\SmallAndLightEnrollment getSmallAndLightEnrollmentBySellerSKU($seller_sku, $marketplace_ids)
...
[**\SellingPartnerApi\Model\SmallAndLightEnrollment**](../Model/SmallAndLightEnrollment.md)
...
> \SellingPartnerApi\Model\SmallAndLightFeePreviews getSmallAndLightFeePreview($body)
...
$body = new \SellingPartnerApi\Model\SmallAndLightFeePreviewRequest(); // \SellingPartnerApi\Model\SmallAndLightFeePreviewRequest | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\SellingPartnerApi\Model\SmallAndLightFeePreviewRequest**](../Model/SmallAndLightFeePreviewRequest.md)|  |

### Return type

[**\SellingPartnerApi\Model\SmallAndLightFeePreviews**](../Model/SmallAndLightFeePreviews.md)
...
> \SellingPartnerApi\Model\SmallAndLightEnrollment putSmallAndLightEnrollmentBySellerSKU($seller_sku, $marketplace_ids)
