...
**tax_exclusive_amount** | [**\SellingPartnerApi\Model\Currency**](Currency.md) | The price of the swapped item minus TaxAmount. | [optional] 
**tax_amount** | [**\SellingPartnerApi\Model\Currency**](Currency.md) | The tax on the network item swap paid by the seller. | [optional] 
