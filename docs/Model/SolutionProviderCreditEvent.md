...
**transaction_amount** | [**\SellingPartnerApi\Model\Currency**](Currency.md) | The amount of the credit. | [optional] 
**transaction_creation_date** | [**\SellingPartnerApi\Model\\DateTime**](\DateTime.md) | The date and time that the credit transaction was created, in ISO 8601 date time format. | [optional] 
