...
class Scenario implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'scenario_id' => 'string',
        'orders' => '\SellingPartnerApi\Model\TestOrder[]'
    ];
     ...
     * Gets orders
     *
     * @return \SellingPartnerApi\Model\TestOrder[]
     */
     ...
     * Sets orders
     *
     * @param \SellingPartnerApi\Model\TestOrder[] $orders A list of orders that can be used by the caller to test each life cycle or scenario.
     *
     * @return $this
     */
