...
class PackageDetail implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'package_reference_id' => '\SellingPartnerApi\Model\PackageReferenceId',
        'carrier_code' => 'string',
        'carrier_name' => 'string',
        ...
        'order_items' => '\SellingPartnerApi\Model\ConfirmShipmentOrderItemsList'
    ];
     ...
     *
     * @return \SellingPartnerApi\Model\PackageReferenceId
     */
     ...
     *
     * @param \SellingPartnerApi\Model\PackageReferenceId $package_reference_id package_reference_id
     *
     * @return $this
     */
     ...
     * Sets carrier_name
     *
     * @param string $carrier_name Carrier Name that will deliver the package. Required when carrierCode is \"Others\"
     *
     * @return $this
     */
     ...
     *
     * @param string $shipping_method Ship method to be used for shipping the order.
     *
     * @return $this
     */
     ...
     *
     * @param string $ship_from_supply_source_id The unique identifier of the supply source.
     *
     * @return $this
     */
     ...
     * Gets order_items
     *
     * @return \SellingPartnerApi\Model\ConfirmShipmentOrderItemsList
     */
     ...
     * Sets order_items
     *
     * @param \SellingPartnerApi\Model\ConfirmShipmentOrderItemsList $order_items The list of order items and quantities to be updated.
     *
     * @return $this
     */
