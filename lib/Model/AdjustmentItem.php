...
class AdjustmentItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'quantity' => 'string',
        'per_unit_amount' => '\SellingPartnerApi\Model\Currency',
     ...
     *
     * @param \SellingPartnerApi\Model\Currency $per_unit_amount The per unit value of the item.
     *
     * @return $this
     */
     ...
     * Sets total_amount
     *
     * @param \SellingPartnerApi\Model\Currency $total_amount The total value of the item.
     *
     * @return $this
     */
