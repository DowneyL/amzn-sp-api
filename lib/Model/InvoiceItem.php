...
class InvoiceItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'invoiced_quantity' => '\SellingPartnerApi\Model\ItemQuantity',
        'net_cost' => '\SellingPartnerApi\Model\Money',
        'purchase_order_number' => 'string',
        'hsn_code' => 'string',
        'credit_note_details' => '\SellingPartnerApi\Model\CreditNoteDetails',
     ...
     *
     * @param \SellingPartnerApi\Model\ItemQuantity $invoiced_quantity Invoiced quantity of this item. Quantity must be greater than zero.
     *
     * @return $this
     */
     ...
     * Sets net_cost
     *
     * @param \SellingPartnerApi\Model\Money $net_cost The item cost to Amazon, which should match the cost on the order. Price information should not be zero or negative. It indicates net unit price. Net cost means VAT is not included in cost.
     *
     * @return $this
     */
     ...
     *
     * @return \SellingPartnerApi\Model\CreditNoteDetails
     */
     ...
     *
     * @param \SellingPartnerApi\Model\CreditNoteDetails $credit_note_details Details required in order to process a credit note. This information is required only if invoiceType is CreditNote.
     *
     * @return $this
     */
     ...
     * Sets tax_details
     *
     * @param \SellingPartnerApi\Model\TaxDetails[] $tax_details Individual tax details per line item.
     *
     * @return $this
     */
     ...
     * Sets charge_details
     *
     * @param \SellingPartnerApi\Model\ChargeDetails[] $charge_details Individual charge details per line item.
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\AllowanceDetails[] $allowance_details Individual allowance details per line item.
     *
     * @return $this
     */
