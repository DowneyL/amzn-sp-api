...
class RegulatedOrderVerificationStatus implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'status' => '\SellingPartnerApi\Model\VerificationStatus',
        'requires_merchant_action' => 'bool',
        'valid_rejection_reasons' => '\SellingPartnerApi\Model\RejectionReason[]',
        'rejection_reason' => '\SellingPartnerApi\Model\RejectionReason',
        'review_date' => 'string',
     ...
     * Gets status
     *
     * @return \SellingPartnerApi\Model\VerificationStatus
     */
     ...
     * Sets status
     *
     * @param \SellingPartnerApi\Model\VerificationStatus $status The verification status of the order.
     *
     * @return $this
     */
     ...
     *
     * @return \SellingPartnerApi\Model\RejectionReason[]
     */
     ...
     *
     * @param \SellingPartnerApi\Model\RejectionReason[] $valid_rejection_reasons A list of valid rejection reasons that may be used to reject the order's regulated information.
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\RejectionReason $rejection_reason The reason for rejecting the order's regulated information. Not present if the order isn't rejected.
     *
     * @return $this
     */
