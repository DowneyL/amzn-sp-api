...
class PayWithAmazonEvent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'transaction_posted_date' => '\SellingPartnerApi\Model\\DateTime',
        'business_object_type' => 'string',
        'sales_channel' => 'string',
        'charge' => '\SellingPartnerApi\Model\ChargeComponent',
        'fee_list' => '\SellingPartnerApi\Model\FeeComponentList',
     ...
     *
     * @param \SellingPartnerApi\Model\\DateTime $transaction_posted_date The date and time when the payment transaction is posted. In ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     * Gets charge
     *
     * @return \SellingPartnerApi\Model\ChargeComponent
     */
     ...
     * Sets charge
     *
     * @param \SellingPartnerApi\Model\ChargeComponent $charge The charge associated with the event.
     *
     * @return $this
     */
     ...
     * Sets fee_list
     *
     * @param \SellingPartnerApi\Model\FeeComponentList $fee_list A list of fees associated with the event.
     *
     * @return $this
     */
