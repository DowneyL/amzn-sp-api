...
class Invoice implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'date' => '\SellingPartnerApi\Model\\DateTime',
        'remit_to_party' => '\SellingPartnerApi\Model\PartyIdentification',
        'ship_to_party' => '\SellingPartnerApi\Model\PartyIdentification',
        'ship_from_party' => '\SellingPartnerApi\Model\PartyIdentification',
        'bill_to_party' => '\SellingPartnerApi\Model\PartyIdentification',
        'payment_terms' => '\SellingPartnerApi\Model\PaymentTerms',
        'invoice_total' => '\SellingPartnerApi\Model\Money',
        'tax_details' => '\SellingPartnerApi\Model\TaxDetails[]',
        'additional_details' => '\SellingPartnerApi\Model\AdditionalDetails[]',
        'charge_details' => '\SellingPartnerApi\Model\ChargeDetails[]',
        'allowance_details' => '\SellingPartnerApi\Model\AllowanceDetails[]',
        'items' => '\SellingPartnerApi\Model\InvoiceItem[]'
    ];
     ...
     * Sets date
     *
     * @param \SellingPartnerApi\Model\\DateTime $date Date when the invoice/credit note information was generated in the origin's accounting system. The invoice date should be on or after the purchase order creation date.
     *
     * @return $this
     */
     ...
     * Sets remit_to_party
     *
     * @param \SellingPartnerApi\Model\PartyIdentification $remit_to_party Name, address and tax details of the party receiving the payment of this invoice.
     *
     * @return $this
     */
     ...
     * Sets ship_to_party
     *
     * @param \SellingPartnerApi\Model\PartyIdentification $ship_to_party Name, address and tax details of the party receiving a shipment of products.
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\PartyIdentification $ship_from_party Name, address and tax details of the party sending a shipment of products.
     *
     * @return $this
     */
     ...
     * Sets bill_to_party
     *
     * @param \SellingPartnerApi\Model\PartyIdentification $bill_to_party Name, address and tax details of the party to whom this invoice is issued.
     *
     * @return $this
     */
     ...
     * Gets payment_terms
     *
     * @return \SellingPartnerApi\Model\PaymentTerms
     */
     ...
     * Sets payment_terms
     *
     * @param \SellingPartnerApi\Model\PaymentTerms $payment_terms The payment terms for the invoice.
     *
     * @return $this
     */
     ...
     * Sets invoice_total
     *
     * @param \SellingPartnerApi\Model\Money $invoice_total Total monetary amount charged in the invoice or full value of credit note to be paid including all relevant taxes. It is the total amount of invoice (including charges, less allowances) before terms discount (if discount is applicable).
     *
     * @return $this
     */
     ...
     * Gets tax_details
     *
     * @return \SellingPartnerApi\Model\TaxDetails[]
     */
     ...
     * Sets tax_details
     *
     * @param \SellingPartnerApi\Model\TaxDetails[] $tax_details Total tax amount details for all line items.
     *
     * @return $this
     */
     ...
     *
     * @return \SellingPartnerApi\Model\AdditionalDetails[]
     */
     ...
     *
     * @param \SellingPartnerApi\Model\AdditionalDetails[] $additional_details Additional details provided by the selling party, for tax related or other purposes.
     *
     * @return $this
     */
     ...
     * Gets charge_details
     *
     * @return \SellingPartnerApi\Model\ChargeDetails[]
     */
     ...
     * Sets charge_details
     *
     * @param \SellingPartnerApi\Model\ChargeDetails[] $charge_details Total charge amount details for all line items.
     *
     * @return $this
     */
     ...
     *
     * @return \SellingPartnerApi\Model\AllowanceDetails[]
     */
     ...
     *
     * @param \SellingPartnerApi\Model\AllowanceDetails[] $allowance_details Total allowance amount details for all line items.
     *
     * @return $this
     */
     ...
     * Gets items
     *
     * @return \SellingPartnerApi\Model\InvoiceItem[]
     */
     ...
     * Sets items
     *
     * @param \SellingPartnerApi\Model\InvoiceItem[] $items The list of invoice items.
     *
     * @return $this
     */
