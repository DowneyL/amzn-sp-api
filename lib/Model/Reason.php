...
class Reason implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'message' => 'string',
        'reason_code' => 'string',
        'links' => '\SellingPartnerApi\Model\Link[]'
    ];
     ...
     * Gets links
     *
     * @return \SellingPartnerApi\Model\Link[]
     */
     ...
     * Sets links
     *
     * @param \SellingPartnerApi\Model\Link[] $links A list of path forward links that may allow Selling Partners to remove the restriction.
     *
     * @return $this
     */
