...
class OrderDetails implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'buying_party' => '\SellingPartnerApi\Model\PartyIdentification',
        ...
        'ship_window' => '\SellingPartnerApi\Model\DateTimeInterval',
        'delivery_window' => '\SellingPartnerApi\Model\DateTimeInterval',
        'items' => '\SellingPartnerApi\Model\OrderItem[]'
    ];
     ...
     * Sets import_details
     *
     * @param \SellingPartnerApi\Model\ImportDetails $import_details If the purchase order is an import order, the details for the import order.
     *
     * @return $this
     */
     ...
     * Sets buying_party
     *
     * @param \SellingPartnerApi\Model\PartyIdentification $buying_party Name/Address and tax details of the buying party.
     *
     * @return $this
     */
     ...
     * Sets ship_to_party
     *
     * @param \SellingPartnerApi\Model\PartyIdentification $ship_to_party Name/Address and tax details of the ship to party. Find a list of fulfillment center addresses for a region on the [Resources page of Amazon Vendor Central](https://vendorcentral.amazon.com/hz/vendor/members/support/help/node/GPZ88XH8HQM97ZV6).
     *
     * @return $this
     */
     ...
     * Sets bill_to_party
     *
     * @param \SellingPartnerApi\Model\PartyIdentification $bill_to_party Name/Address and tax details of the bill to party.
     *
     * @return $this
     */
     ...
     * Gets ship_window
     *
     * @return \SellingPartnerApi\Model\DateTimeInterval
     */
     ...
     * Sets ship_window
     *
     * @param \SellingPartnerApi\Model\DateTimeInterval $ship_window This indicates the ship window. Format is start and end date separated by double hyphen (--). For example, 2007-03-01T13:00:00Z--2007-03-11T15:30:00Z.
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\DateTimeInterval $delivery_window This indicates the delivery window. Format is start and end date separated by double hyphen (--). For example, 2007-03-01T13:00:00Z--2007-03-11T15:30:00Z.
     *
     * @return $this
     */
     ...
     * Gets items
     *
     * @return \SellingPartnerApi\Model\OrderItem[]
     */
     ...
     * Sets items
     *
     * @param \SellingPartnerApi\Model\OrderItem[] $items A list of items in this purchase order.
     *
     * @return $this
     */
