...
class DebtRecoveryItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'original_amount' => '\SellingPartnerApi\Model\Currency',
        'group_begin_date' => '\SellingPartnerApi\Model\\DateTime',
        'group_end_date' => '\SellingPartnerApi\Model\\DateTime'
    ];
     ...
     *
     * @param \SellingPartnerApi\Model\Currency $recovery_amount The amount applied for the recovery item.
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\Currency $original_amount The original debt amount.
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\\DateTime $group_begin_date The beginning date and time of the financial event group that contains the debt. In ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     * Sets group_end_date
     *
     * @param \SellingPartnerApi\Model\\DateTime $group_end_date The ending date and time of the financial event group that contains the debt. In ISO 8601 date time format.
     *
     * @return $this
     */
