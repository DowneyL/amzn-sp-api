...
class ItemSearchResults implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'refinements' => '\SellingPartnerApi\Model\Refinements',
        'items' => '\SellingPartnerApi\Model\Item[]'
    ];
     ...
     * Sets pagination
     *
     * @param \SellingPartnerApi\Model\Pagination $pagination If available, the `nextToken` and/or `previousToken` values required to return paginated results.
     *
     * @return $this
     */
     ...
     * Gets refinements
     *
     * @return \SellingPartnerApi\Model\Refinements
     */
     ...
     * Sets refinements
     *
     * @param \SellingPartnerApi\Model\Refinements $refinements Search refinements for `keywords`-based searches.
     *
     * @return $this
     */
     ...
     * Sets items
     *
     * @param \SellingPartnerApi\Model\Item[] $items A list of items from the Amazon catalog.
     *
     * @return $this
     */
