...
class FeaturedOfferExpectedPrice implements ModelInterface, ArrayAccess
{
     ...
     * Sets listing_price
     *
     * @param \SellingPartnerApi\Model\MoneyType $listing_price A computed listing price at or below which a seller can expect to become the featured offer (before applicable promotions).
     *
     * @return $this
     */
