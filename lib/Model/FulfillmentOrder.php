...
class FulfillmentOrder implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'received_date' => '\SellingPartnerApi\Model\Timestamp',
        'fulfillment_order_status' => '\SellingPartnerApi\Model\FulfillmentOrderStatus',
        'status_updated_date' => '\SellingPartnerApi\Model\Timestamp',
     ...
     *
     * @param \SellingPartnerApi\Model\Timestamp $displayable_order_date A date and time submitted with the createFulfillmentOrder operation. Displays as the order date in recipient-facing materials such as the packing slip.
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\Address $destination_address The destination address submitted with the createFulfillmentOrder operation.
     *
     * @return $this
     */
     ...
     * Sets received_date
     *
     * @param \SellingPartnerApi\Model\Timestamp $received_date The date and time that the fulfillment order was received by an Amazon fulfillment center.
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\Timestamp $status_updated_date The date and time that the status of the fulfillment order last changed, in ISO 8601 date time format.
     *
     * @return $this
     */
