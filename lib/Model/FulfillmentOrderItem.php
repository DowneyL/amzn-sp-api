...
class FulfillmentOrderItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'quantity' => '\SellingPartnerApi\Model\Quantity',
        'gift_message' => 'string',
        'displayable_comment' => 'string',
        'fulfillment_network_sku' => 'string',
        'order_item_disposition' => 'string',
        'cancelled_quantity' => '\SellingPartnerApi\Model\Quantity',
        'unfulfillable_quantity' => '\SellingPartnerApi\Model\Quantity',
        'estimated_ship_date' => '\SellingPartnerApi\Model\Timestamp',
        'estimated_arrival_date' => '\SellingPartnerApi\Model\Timestamp',
        'per_unit_price' => '\SellingPartnerApi\Model\Money',
        'per_unit_tax' => '\SellingPartnerApi\Model\Money',
        'per_unit_declared_value' => '\SellingPartnerApi\Model\Money'
    ];
     ...
     * Gets quantity
     *
     * @return \SellingPartnerApi\Model\Quantity
     */
     ...
     * Sets quantity
     *
     * @param \SellingPartnerApi\Model\Quantity $quantity quantity
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\Quantity $cancelled_quantity The item quantity that was cancelled by the seller.
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\Quantity $unfulfillable_quantity The item quantity that is unfulfillable.
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\Timestamp $estimated_arrival_date The estimated arrival date and time of the item quantity. Note that this value can change over time. If the shipment that contains the item quantity has been cancelled, estimatedArrivalDate is not returned.
     *
     * @return $this
     */
     ...
     * Sets per_unit_price
     *
     * @param \SellingPartnerApi\Model\Money $per_unit_price The amount to be collected from the recipient for this item in a COD (Cash On Delivery) order.
     *
     * @return $this
     */
     ...
     * Sets per_unit_tax
     *
     * @param \SellingPartnerApi\Model\Money $per_unit_tax The tax on the amount to be collected from the recipient for this item in a COD (Cash On Delivery) order.
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\Money $per_unit_declared_value The monetary value assigned by the seller to this item.
     *
     * @return $this
     */
