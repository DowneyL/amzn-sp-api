...
class OrderItem implements ModelInterface, ArrayAccess
{
     ...
     * Sets net_cost
     *
     * @param \SellingPartnerApi\Model\Money $net_cost The price to Amazon each (cost).
     *
     * @return $this
     */
     ...
     * Sets list_price
     *
     * @param \SellingPartnerApi\Model\Money $list_price The price to Amazon each (list).
     *
     * @return $this
     */
