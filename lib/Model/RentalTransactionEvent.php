...
class RentalTransactionEvent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'rental_charge_list' => '\SellingPartnerApi\Model\ChargeComponentList',
        'rental_fee_list' => '\SellingPartnerApi\Model\FeeComponentList',
        'marketplace_name' => 'string',
        'rental_initial_value' => '\SellingPartnerApi\Model\Currency',
        'rental_reimbursement' => '\SellingPartnerApi\Model\Currency',
        'rental_tax_withheld_list' => '\SellingPartnerApi\Model\TaxWithheldComponentList'
    ];
     ...
     *
     * @param \SellingPartnerApi\Model\ChargeComponentList $rental_charge_list A list of charges associated with the rental event.
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\FeeComponentList $rental_fee_list A list of fees associated with the rental event.
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\Currency $rental_initial_value The amount of money the customer originally paid to rent the item. This value is only returned for RentalChargeFailureReimbursement and RentalLostItemReimbursement events.
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\Currency $rental_reimbursement The amount of money Amazon sends the seller to compensate for a lost item or a failed charge. This value is only returned for RentalChargeFailureReimbursement and RentalLostItemReimbursement events.
     *
     * @return $this
     */
     ...
     *
     * @return \SellingPartnerApi\Model\TaxWithheldComponentList
     */
     ...
     *
     * @param \SellingPartnerApi\Model\TaxWithheldComponentList $rental_tax_withheld_list A list of taxes withheld information for a rental item.
     *
     * @return $this
     */
