...
class ItemRelationship implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'child_asins' => 'string[]',
        'parent_asins' => 'string[]',
        'variation_theme' => '\SellingPartnerApi\Model\ItemVariationTheme',
        'type' => 'string'
    ];
     ...
     *
     * @return \SellingPartnerApi\Model\ItemVariationTheme
     */
     ...
     *
     * @param \SellingPartnerApi\Model\ItemVariationTheme $variation_theme For \"VARIATION\" relationships, variation theme indicating the combination of Amazon item catalog attributes that define the variation family.
     *
     * @return $this
     */
