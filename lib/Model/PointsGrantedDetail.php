...
class PointsGrantedDetail implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'points_number' => 'int',
        'points_monetary_value' => '\SellingPartnerApi\Model\Money'
    ];
     ...
     *
     * @param \SellingPartnerApi\Model\Money $points_monetary_value The monetary value of the Amazon Points granted.
     *
     * @return $this
     */
