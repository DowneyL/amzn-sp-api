...
class ProductTypeDefinition implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'meta_schema' => '\SellingPartnerApi\Model\SchemaLink',
        'schema' => '\SellingPartnerApi\Model\SchemaLink',
        'requirements' => 'string',
        'requirements_enforced' => 'string',
        'property_groups' => 'map[string,\SellingPartnerApi\Model\PropertyGroup]',
        'locale' => 'string',
        'marketplace_ids' => 'string[]',
        'product_type' => 'string',
        'product_type_version' => '\SellingPartnerApi\Model\ProductTypeVersion'
    ];
     ...
     * Gets meta_schema
     *
     * @return \SellingPartnerApi\Model\SchemaLink
     */
     ...
     * Sets meta_schema
     *
     * @param \SellingPartnerApi\Model\SchemaLink $meta_schema Link to meta-schema describing the vocabulary used by the product type schema.
     *
     * @return $this
     */
     ...
     * Sets schema
     *
     * @param \SellingPartnerApi\Model\SchemaLink $schema Link to schema describing the attributes and requirements for the product type.
     *
     * @return $this
     */
     ...
     *
     * @return map[string,\SellingPartnerApi\Model\PropertyGroup]
     */
     ...
     *
     * @param map[string,\SellingPartnerApi\Model\PropertyGroup] $property_groups Mapping of property group names to property groups. Property groups represent logical groupings of schema properties that can be used for display or informational purposes.
     *
     * @return $this
     */
     ...
     *
     * @return \SellingPartnerApi\Model\ProductTypeVersion
     */
     ...
     *
     * @param \SellingPartnerApi\Model\ProductTypeVersion $product_type_version The version details for the Amazon product type.
     *
     * @return $this
     */
