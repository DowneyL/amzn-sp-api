...
class PartneredEstimate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'amount' => '\SellingPartnerApi\Model\Amount',
        'confirm_deadline' => '\SellingPartnerApi\Model\TimeStampStringType',
        'void_deadline' => '\SellingPartnerApi\Model\TimeStampStringType'
    ];
     ...
     * Sets amount
     *
     * @param \SellingPartnerApi\Model\Amount $amount The amount that the Amazon-partnered carrier will charge to ship the inbound shipment.
     *
     * @return $this
     */
     ...
     *
     * @return \SellingPartnerApi\Model\TimeStampStringType
     */
     ...
     *
     * @param \SellingPartnerApi\Model\TimeStampStringType $confirm_deadline The date in ISO 8601 date time format by which this estimate must be confirmed. After this date the estimate is no longer valid and cannot be confirmed.  Returned only if the TransportStatus value of the inbound shipment is ESTIMATED.
     *
     * @return $this
     */
