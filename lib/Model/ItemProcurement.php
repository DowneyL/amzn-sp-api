...
class ItemProcurement implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'cost_price' => '\SellingPartnerApi\Model\Money'
    ];
     ...
     * Sets cost_price
     *
     * @param \SellingPartnerApi\Model\Money $cost_price The price (numeric value) that you want Amazon to pay you for this product.
     *
     * @return $this
     */
