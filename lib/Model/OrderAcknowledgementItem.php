...
class OrderAcknowledgementItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'ordered_quantity' => '\SellingPartnerApi\Model\ItemQuantity',
        'net_cost' => '\SellingPartnerApi\Model\Money',
        'list_price' => '\SellingPartnerApi\Model\Money',
        'discount_multiplier' => 'string',
        'item_acknowledgements' => '\SellingPartnerApi\Model\OrderItemAcknowledgement[]'
    ];
     ...
     *
     * @param \SellingPartnerApi\Model\ItemQuantity $ordered_quantity The quantity of this item ordered.
     *
     * @return $this
     */
     ...
     * Sets net_cost
     *
     * @param \SellingPartnerApi\Model\Money $net_cost The cost to Amazon, which should match the cost on the invoice. This is a required field. If this is left blank the file will reject in Amazon systems. Price information should not be zero or negative. Indicates a net unit price.
     *
     * @return $this
     */
     ...
     * Sets list_price
     *
     * @param \SellingPartnerApi\Model\Money $list_price The list price. This is required only if a vendor sells books with a list price.
     *
     * @return $this
     */
     ...
     *
     * @return \SellingPartnerApi\Model\OrderItemAcknowledgement[]
     */
     ...
     *
     * @param \SellingPartnerApi\Model\OrderItemAcknowledgement[] $item_acknowledgements This is used to indicate acknowledged quantity.
     *
     * @return $this
     */
