...
class OfferProgramConfigurationPromotionsDiscountFunding implements ModelInterface, ArrayAccess
{
    ...
    public function setPercentage($percentage)
    {
        ...
        if (!is_null($percentage) && ($percentage > 100)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling OfferProgramConfigurationPromotionsDiscountFunding., must be smaller than or equal to 100.');
        }
