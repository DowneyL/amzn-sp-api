...
class TrackingEvent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'event_date' => '\SellingPartnerApi\Model\Timestamp',
        'event_address' => '\SellingPartnerApi\Model\TrackingAddress',
        'event_code' => '\SellingPartnerApi\Model\EventCode',
     ...
     * Sets event_date
     *
     * @param \SellingPartnerApi\Model\Timestamp $event_date The date and time that the delivery event took place, in ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     * Sets event_address
     *
     * @param \SellingPartnerApi\Model\TrackingAddress $event_address The city where the delivery event took place.
     *
     * @return $this
     */
     ...
     * Gets event_code
     *
     * @return \SellingPartnerApi\Model\EventCode
     */
     ...
     * Sets event_code
     *
     * @param \SellingPartnerApi\Model\EventCode $event_code The event code for the delivery event.
     *
     * @return $this
     */
