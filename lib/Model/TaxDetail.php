...
class TaxDetail implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'tax_type' => 'string',
        'tax_rate' => '\SellingPartnerApi\Model\Decimal',
        'tax_amount' => '\SellingPartnerApi\Model\Money',
        'taxable_amount' => '\SellingPartnerApi\Model\Money'
    ];
     ...
     * Gets tax_rate
     *
     * @return \SellingPartnerApi\Model\Decimal
     */
     ...
     * Sets tax_rate
     *
     * @param \SellingPartnerApi\Model\Decimal $tax_rate Tax percentage applied. Percentage must be expressed in decimal.
     *
     * @return $this
     */
     ...
     * Sets tax_amount
     *
     * @param \SellingPartnerApi\Model\Money $tax_amount Total tax amount applied on invoice total or an item total.
     *
     * @return $this
     */
     ...
     * Sets taxable_amount
     *
     * @param \SellingPartnerApi\Model\Money $taxable_amount This field will contain the invoice amount that is taxable at the rate specified in the tax rate field.
     *
     * @return $this
     */
