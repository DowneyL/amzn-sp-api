...
class FeePreview implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'asin' => 'string',
        'price' => '\SellingPartnerApi\Model\MoneyType',
        'fee_breakdown' => '\SellingPartnerApi\Model\FeeLineItem[]',
        'total_fees' => '\SellingPartnerApi\Model\MoneyType',
        'errors' => '\SellingPartnerApi\Model\Error[]'
    ];
     ...
     * Sets price
     *
     * @param \SellingPartnerApi\Model\MoneyType $price The price that the seller plans to charge for the item.
     *
     * @return $this
     */
     ...
     * Gets fee_breakdown
     *
     * @return \SellingPartnerApi\Model\FeeLineItem[]
     */
     ...
     * Sets fee_breakdown
     *
     * @param \SellingPartnerApi\Model\FeeLineItem[] $fee_breakdown A list of the Small and Light fees for the item.
     *
     * @return $this
     */
     ...
     * Sets total_fees
     *
     * @param \SellingPartnerApi\Model\MoneyType $total_fees The total fees charged if the item participated in the Small and Light program.
     *
     * @return $this
     */
     ...
     * Sets errors
     *
     * @param \SellingPartnerApi\Model\Error[] $errors One or more unexpected errors occurred during the getSmallAndLightFeePreview operation.
     *
     * @return $this
     */
