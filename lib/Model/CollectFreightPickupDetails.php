...
class CollectFreightPickupDetails implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['requested_pick_up'] = isset($data['requested_pick_up']) ? $data['requested_pick_up'] : null;
        $this->container['scheduled_pick_up'] = isset($data['scheduled_pick_up']) ? $data['scheduled_pick_up'] : null;
        $this->container['carrier_assignment_date'] = isset($data['carrier_assignment_date']) ? $data['carrier_assignment_date'] : null;
    }
     ...
     *
     * @param \DateTime $requested_pick_up Date on which the items can be picked up from vendor warehouse by Buyer used for WePay/Collect vendors.
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $scheduled_pick_up Date on which the items are scheduled to be picked from vendor warehouse by Buyer used for WePay/Collect vendors.
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $carrier_assignment_date Date on which the carrier is being scheduled to pickup items from vendor warehouse by Byer used for WePay/Collect vendors.
     *
     * @return $this
     */
