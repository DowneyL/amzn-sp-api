...
class Preference implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \SellingPartnerApi\Model\AutoEnrollmentPreference[] $auto_enrollment Filters the results to only include offers with the auto-enrollment preference specified.
     *
     * @return $this
     */
