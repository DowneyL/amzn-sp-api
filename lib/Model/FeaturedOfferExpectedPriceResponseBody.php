...
class FeaturedOfferExpectedPriceResponseBody implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'featured_offer_expected_price_results' => '\SellingPartnerApi\Model\FeaturedOfferExpectedPriceResultList',
        'errors' => '\SellingPartnerApi\Model\ErrorList'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['featured_offer_expected_price_results'] = isset($data['featured_offer_expected_price_results']) ? $data['featured_offer_expected_price_results'] : null;
     ...
     *
     * @param \SellingPartnerApi\Model\OfferIdentifier $offer_identifier Metadata that identifies the target offer for which the featured offer expected price result data was computed.
     *
     * @return $this
     */
     ...
     *
     * @return \SellingPartnerApi\Model\FeaturedOfferExpectedPriceResultList
     */
     ...
     *
     * @param \SellingPartnerApi\Model\FeaturedOfferExpectedPriceResultList $featured_offer_expected_price_results The featured offer expected price results for the requested target offer.
     *
     * @return $this
     */
     ...
     * Gets errors
     *
     * @return \SellingPartnerApi\Model\ErrorList
     */
     ...
     * Sets errors
     *
     * @param \SellingPartnerApi\Model\ErrorList $errors The errors that occurred if the operation was not successful (HTTP status code non-200).
     *
     * @return $this
     */
