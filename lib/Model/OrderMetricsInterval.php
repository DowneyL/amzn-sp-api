...
class OrderMetricsInterval implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'order_count' => 'int',
        'average_unit_price' => '\SellingPartnerApi\Model\Money',
        'total_sales' => '\SellingPartnerApi\Model\Money'
    ];
     ...
     *
     * @param \SellingPartnerApi\Model\Money $average_unit_price The average price for an item based on the specified filters. Formula is totalSales/unitCount.
     *
     * @return $this
     */
     ...
     * Sets total_sales
     *
     * @param \SellingPartnerApi\Model\Money $total_sales The total ordered product sales for all orders based on the specified filters.
     *
     * @return $this
     */
