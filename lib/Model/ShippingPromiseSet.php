...
class ShippingPromiseSet implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'delivery_window' => '\SellingPartnerApi\Model\TimeRange',
        'receive_window' => '\SellingPartnerApi\Model\TimeRange'
    ];
     ...
     *
     * @return \SellingPartnerApi\Model\TimeRange
     */
     ...
     *
     * @param \SellingPartnerApi\Model\TimeRange $delivery_window The time window in which the shipment will be delivered.
     *
     * @return $this
     */
     ...
     * Sets receive_window
     *
     * @param \SellingPartnerApi\Model\TimeRange $receive_window The time window in which Amazon Shipping will pick up the shipment.
     *
     * @return $this
     */
