...
class RemovalShipmentAdjustmentEvent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'removal_shipment_item_adjustment_list' => '\SellingPartnerApi\Model\RemovalShipmentItemAdjustment[]'
    ];
     ...
     * Sets posted_date
     *
     * @param \SellingPartnerApi\Model\\DateTime $posted_date The date when the financial event was posted.
     *
     * @return $this
     */
     ...
     *
     * @return \SellingPartnerApi\Model\RemovalShipmentItemAdjustment[]
     */
     ...
     *
     * @param \SellingPartnerApi\Model\RemovalShipmentItemAdjustment[] $removal_shipment_item_adjustment_list A comma-delimited list of Removal shipmentItemAdjustment details for FBA inventory.
     *
     * @return $this
     */
