...
class BuyBoxPriceType implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'landed_price' => '\SellingPartnerApi\Model\MoneyType',
     ...
     * Sets offer_type
     *
     * @param \SellingPartnerApi\Model\OfferCustomerType $offer_type Indicates the type of customer that the offer is valid for.<br><br>When the offer type is B2C in a quantity discount, the seller is winning the Buy Box because others do not have inventory at that quantity, not because they have a quantity discount on the ASIN.
     *
     * @return $this
     */
     ...
     * Sets landed_price
     *
     * @param \SellingPartnerApi\Model\MoneyType $landed_price The value calculated by adding ListingPrice + Shipping - Points.
     *
     * @return $this
     */
