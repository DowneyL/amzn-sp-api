...
class RangeSlotCapacityQuery implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'capacity_types' => '\SellingPartnerApi\Model\CapacityType[]',
     ...
     * Sets capacity_types
     *
     * @param \SellingPartnerApi\Model\CapacityType[] $capacity_types An array of capacity types which are being requested. Default value is `[SCHEDULED_CAPACITY]`.
     *
     * @return $this
     */
