...
class ShipmentRequestDetails implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'seller_order_id' => '\SellingPartnerApi\Model\SellerOrderId',
        'item_list' => '\SellingPartnerApi\Model\ItemList',
        'ship_from_address' => '\SellingPartnerApi\Model\Address',
        'package_dimensions' => '\SellingPartnerApi\Model\PackageDimensions',
        'weight' => '\SellingPartnerApi\Model\Weight',
        'must_arrive_by_date' => '\SellingPartnerApi\Model\Timestamp',
        'ship_date' => '\SellingPartnerApi\Model\Timestamp',
        'shipping_service_options' => '\SellingPartnerApi\Model\ShippingServiceOptions',
        'label_customization' => '\SellingPartnerApi\Model\LabelCustomization'
    ];
     ...
     *
     * @param \SellingPartnerApi\Model\AmazonOrderId $amazon_order_id An Amazon-defined order identifier in 3-7-7 format.
     *
     * @return $this
     */
     ...
     *
     * @return \SellingPartnerApi\Model\SellerOrderId
     */
     ...
     *
     * @param \SellingPartnerApi\Model\SellerOrderId $seller_order_id A seller-defined order identifier.
     *
     * @return $this
     */
     ...
     * Gets item_list
     *
     * @return \SellingPartnerApi\Model\ItemList
     */
     ...
     * Sets item_list
     *
     * @param \SellingPartnerApi\Model\ItemList $item_list item_list
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\Address $ship_from_address The address of the sender.
     *
     * @return $this
     */
     ...
     *
     * @return \SellingPartnerApi\Model\PackageDimensions
     */
     ...
     *
     * @param \SellingPartnerApi\Model\PackageDimensions $package_dimensions The package dimensions.
     *
     * @return $this
     */
     ...
     * Sets weight
     *
     * @param \SellingPartnerApi\Model\Weight $weight The package weight.
     *
     * @return $this
     */
     ...
     *
     * @param \SellingPartnerApi\Model\Timestamp $must_arrive_by_date The date by which the package must arrive to keep the promise to the customer, in ISO 8601 datetime format. If MustArriveByDate is specified, only shipping service offers that can be delivered by that date are returned.
     *
     * @return $this
     */
     ...
     * Sets ship_date
     *
     * @param \SellingPartnerApi\Model\Timestamp $ship_date When used in a request, this is the date and time that the seller wants to ship the package. When used in a response, this is the date and time that the package can be shipped by the indicated method.
     *
     * @return $this
     */
     ...
     *
     * @return \SellingPartnerApi\Model\ShippingServiceOptions
     */
     ...
     *
     * @param \SellingPartnerApi\Model\ShippingServiceOptions $shipping_service_options Extra services offered by the carrier.
     *
     * @return $this
     */
     ...
     *
     * @return \SellingPartnerApi\Model\LabelCustomization
     */
     ...
     *
     * @param \SellingPartnerApi\Model\LabelCustomization $label_customization Label customization options.
     *
     * @return $this
     */
