...
namespace SellingPartnerApi\Api\Authorization;
...
class AuthorizationApi
{
    ...
    protected function getAuthorizationCodeRequest($sellingPartnerId, $developerId, $mwsAuthToken)
    {
        ...
        if ($sellingPartnerId !== null) {
            $queryParams['sellingPartnerId'] = ObjectSerializer::toQueryValue($sellingPartnerId, null);
        }
        // query params
        if ($developerId !== null) {
            $queryParams['developerId'] = ObjectSerializer::toQueryValue($developerId, null);
        }
        // query params
        if ($mwsAuthToken !== null) {
            $queryParams['mwsAuthToken'] = ObjectSerializer::toQueryValue($mwsAuthToken, null);
        }
