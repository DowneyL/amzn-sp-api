...
class OffersApi
{
     ...
     *
     * @param  \SellingPartnerApi\Model\ListOfferMetricsRequest $body The request body for the &#x60;listOfferMetrics&#x60; operation. (optional)
     *
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SellingPartnerApi\Model\ListOfferMetricsResponse
     */
     ...
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApi\Model\ListOfferMetricsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listOfferMetricsWithHttpInfo($body = null)
    {
        $returnType = '\SellingPartnerApi\Model\ListOfferMetricsResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\ListOfferMetricsResponse',
     ...
     *
     * @param  \SellingPartnerApi\Model\ListOffersRequest $body body (optional)
     *
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SellingPartnerApi\Model\ListOffersResponse
     */
     ...
     *
     * @param  \SellingPartnerApi\Model\ListOffersRequest $body (optional)
     *
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApi\Model\ListOffersResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listOffersWithHttpInfo($body = null)
    {
        $returnType = '\SellingPartnerApi\Model\ListOffersResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\ListOffersResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
