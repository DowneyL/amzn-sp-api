...
class ShipmentApi
{
     ...
     * @param  \SellingPartnerApi\Model\UpdateShipmentStatusRequest $payload The request body for the updateShipmentStatus operation. (required)
     *
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\UpdateShipmentStatusErrorResponse',
