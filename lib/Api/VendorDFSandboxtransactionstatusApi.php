...
class VendorDFSandboxtransactionstatusApi
{
    ...
    {
        list($response) = $this->getOrderScenariosWithHttpInfo($transaction_id);
        return $response;
    }
     ...
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApi\Model\TransactionStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderScenariosWithHttpInfo($transaction_id)
    {
        $returnType = '\SellingPartnerApi\Model\TransactionStatus';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\TransactionStatus',
