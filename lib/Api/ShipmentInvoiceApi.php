...
class ShipmentInvoiceApi
{
     ...
     * @return \SellingPartnerApi\Model\GetInvoiceStatusResponse
     */
     ...
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApi\Model\GetInvoiceStatusResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInvoiceStatusWithHttpInfo($shipment_id)
    {
        $returnType = '\SellingPartnerApi\Model\GetInvoiceStatusResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\GetInvoiceStatusResponse',
     ...
     * @param  \SellingPartnerApi\Model\SubmitInvoiceRequest $body body (required)
     *
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SellingPartnerApi\Model\SubmitInvoiceResponse
     */
     ...
     *
     * @param  string $shipment_id The identifier for the shipment. (required)
     * @param  \SellingPartnerApi\Model\SubmitInvoiceRequest $body (required)
     *
     * @throws \SellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApi\Model\SubmitInvoiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitInvoiceWithHttpInfo($shipment_id, $body)
    {
        $returnType = '\SellingPartnerApi\Model\SubmitInvoiceResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApi\Model\SubmitInvoiceResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
